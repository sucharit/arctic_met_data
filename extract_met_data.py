from main_met_data import extract_data
...
extract_data(parameters=["WS","WD","TW","TI","AT","BP","BC","BS","ST","LA","LO",], start_time=(8,11,18,0), stop_time=(10,11,23,30), interval=(0,0,0,1), print_output=False, output_file="first_try.csv")#more involved. Doesn't print, but saves to file "first_try.csv". Starts at Aug-11-6pm, goes up to Oct-11-11:30pm, in increments of 1min. (Produces a huge file "first_try.csv", rewriting it if it already exists.)


#Just comment out the above example extract_data functions, and write your own. Then run this file in a terminal as:
#python extract_met_data.py
